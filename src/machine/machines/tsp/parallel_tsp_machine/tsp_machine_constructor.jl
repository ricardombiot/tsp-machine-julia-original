function new(graf :: Grafo, km_b :: Km, color_origin :: Color = Color(0))
    ...
    db = DatabaseActionsMultiThread.new(n, km_b, color_origin)
    db_controller = DatabaseMemoryController.new()
    machine = TravellingSalesmanMachineParallel(n, actual_km, km_b, km_solution_recived, color_origin, graf,
...
function init!(machine :: TravellingSalesmanMachineParallel)
