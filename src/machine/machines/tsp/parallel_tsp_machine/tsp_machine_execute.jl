function execute!(machine :: TravellingSalesmanMachineParallel)
...
function make_step!(machine :: TravellingSalesmanMachineParallel) :: Bool
...
function free_memory!(machine :: TravellingSalesmanMachineParallel)
...
function rules_to_halt_machine(machine :: TravellingSalesmanMachineParallel) :: Bool
    km_to_halt = km_target(machine)
    return km_to_halt == machine.actual_km
end

function km_target(machine :: TravellingSalesmanMachineParallel) :: Km
...
function execute_line!(machine :: TravellingSalesmanMachineParallel)
