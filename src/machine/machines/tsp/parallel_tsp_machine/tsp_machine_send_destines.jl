...
function send_destines!(machine :: TravellingSalesmanMachineParallel, origin :: Color)
...
function is_valid_destine(machine :: TravellingSalesmanMachineParallel, action :: Action, destine :: Color)
...
function check_if_solution_recived(machine :: TravellingSalesmanMachineParallel, destine :: Color, km_destine :: Km)
    if destine == machine.color_origin
